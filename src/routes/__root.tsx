...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Jaya Putra Syaipul" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Fullstack Web Developer yang membangun website cepat, stabil, dan mudah digunakan untuk UMKM & personal branding.",
          image: "/img/profile-square.png",
          email: "mailto:jayaputrasyaipul7@gmail.com",
